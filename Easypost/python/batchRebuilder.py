...
def rebuildShipment(shipment):
    LOGS = Path('/a/path/to/a/directory/for/dumping/shipment/logs/'+str(shipment['id'])+'.txt')
    ...
    # place the shipment ID into dict for rebuilding batch later
    batchShipment = {
        "id": ID
        }
