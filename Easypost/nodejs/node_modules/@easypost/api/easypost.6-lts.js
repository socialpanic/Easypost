...
class API {
  ...
  request(path = '', method = METHODS.GET, params = {}, headers = {}) {
    ...
    return _asyncToGenerator(function* () {
      ...
      let req = _this.agent[method](_this.buildPath(path)).set(API.buildHeaders(headers));
  ...
  return _temp = _class = class Shipment extends Object(_base__WEBPACK_IMPORTED_MODULE_1__["default"])(api) {
    ...
    regenerateRates() {
      ...
      return _asyncToGenerator(function* () {
        ...
        return _this4.rpc('rerate', undefined, undefined, 'post');
      })();
    }
    ...
    getSmartrates() {
      ...
      return _asyncToGenerator(function* () {
        ...
        return _this5.rpc('smartrate', undefined, undefined, 'get');
      })();
    }
    ...
    refund() {
      ...
      return _asyncToGenerator(function* () {
        _this7.verifyParameters({
          this: ['id']
        });

        return _this7.rpc('refund');
      })();
    }
